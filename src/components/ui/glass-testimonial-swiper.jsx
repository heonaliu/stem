  ...
  return (
    <section className="testimonials-stack relative pb-10">
      {testimonials.map((testimonial, index) => {
        ...
        const tagClasses = (type) => type === 'featured' 
        ...
        return (
          <div
            ...
            <div className="p-3 md:p-8">
              ...
              <div
                className="flex flex-col md:flex-row items-start md:items-center justify-between border-t border-border pt-4 gap-4">
      ...
      <div
        className="pagination flex gap-2 justify-center absolute bottom-0 left-0 right-0">
